                  ...
                  {[
                    {
                      id: 'wordpress',
                      name: 'WordPress',
                      icon: <Globe className="w-8 h-8 mb-2 text-blue-400" />,
                    },
                    {
                      id: 'webflow',
                      name: 'Webflow',
                      icon: <Code className="w-8 h-8 mb-2 text-blue-500" />,
                    },
                    {
                      id: 'shopify',
                      name: 'Shopify',
                      icon: <ShoppingBag className="w-8 h-8 mb-2 text-green-400" />,
                    },
                    {
                      id: 'custom',
                      name: 'Custom/API',
                    ...
                    >
                      {cms.icon}
                      <span
                        className={`text-sm font-medium ${formData.cms === cms.id ? 'text-accent-light' : 'text-secondary'}`}
                      >
                        {cms.name}
                      </span>
                    </button>
              ...
              {formData.cms === 'wordpress' && (
                <div className="bg-main/50 border border-border rounded-xl p-4 space-y-3 animate-fadeIn">
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    <input
                      type="text"
                      placeholder="WP Admin URL (e.g. site.com/wp-json)"
                      className="bg-surface border border-border rounded px-3 py-2 text-sm text-white focus:border-accent outline-none"
                    />
                    <input
                      type="text"
                  ...
                  <p className="text-xs text-muted">
                    We recommend creating a specific user for API access.
                  </p>
                </div>
              )}
              {formData.cms === 'webflow' && (
                <div className="bg-main/50 border border-border rounded-xl p-4 space-y-3 animate-fadeIn">
                  ...
                  <input
                    ...
                    className="w-full bg-surface border border-border rounded px-3 py-2 text-sm text-white focus:border-accent outline-none"
                  />
                </div>
              )}
            </div>
          ...
          {step === 3 && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="flex items-start gap-3 p-4 bg-blue-900/20 border border-blue-500/20 rounded-lg text-sm text-blue-200">
                ...
                <p>
                  Once connected, AutopilotRank will start analyzing your niche and generating topic
                  ideas immediately. The first draft will be ready for review in ~10 minutes.
                </p>
              </div>
            </div>
          )}
