...
function loadServerEnv(): IServerEnv {
  ...
  const env = {
    ...
    DOMAIN_NAME: metaEnv.DOMAIN_NAME || 'autopilotrank.com',
    WORKER_NAME: metaEnv.WORKER_NAME || 'autopilotrank',
    // Cron Job Authentication
    ...
    EMAIL_FROM_ADDRESS: metaEnv.EMAIL_FROM_ADDRESS || 'noreply@autopilotrank.com',
    SUPPORT_EMAIL:
      metaEnv.SUPPORT_EMAIL || metaEnv.PUBLIC_SUPPORT_EMAIL || 'support@autopilotrank.com',
