 ...
 */
function getRequestFromCookies(cookies: AstroCookies): Request | null {
 ...
 */
export async function createClient(cookies: AstroCookies, request?: AstroRequest): Promise<SupabaseClient> {
